  ...
  const values = [
    {
      icon: <Target className="h-8 w-8" />,
      title: 'Excellence',
      description: 'We deliver top-notch IT solutions that exceed client expectations every time.'
    },
    {
      icon: <Eye className="h-8 w-8" />,
      title: 'Innovation',
      description: 'Leveraging cutting-edge technologies to create future-ready digital solutions.'
    },
    {
      icon: <Award className="h-8 w-8" />,
      title: 'Quality',
      description: 'Uncompromising focus on reliability, performance, and scalability in all our projects.'
    },
    {
      icon: <Users className="h-8 w-8" />,
      title: 'Partnership',
      description: 'We collaborate closely with clients, ensuring long-term trust and success.'
    }
  ];
  ...
  const milestones = [
    {
      year: '2025',
      title: 'Company Registration',
      description: 'Polynovex Limited officially registered as an IT service company.'
    },
    {
      year: '2025',
      title: 'Technology Division Launch',
      description: 'Introduced software development, cloud solutions, and networking services.'
    },
    {
      year: '2025',
      title: 'Educational Platforms',
      description: 'Rolled out CBT exam and e-learning platforms for institutions.'
    },
    {
      year: '2025',
      title: 'Enterprise Solutions',
      description: 'Began providing tailored enterprise IT solutions for growing businesses.'
    }
  ];
    ...
    <p className="text-xl md:text-2xl max-w-3xl mx-auto leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl font-bold text-gray-900 mb-8">Our Mission</h2>
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                To empower organizations with cutting-edge IT solutions in software 
                development, cloud services, networking, and educational platforms. 
                We are committed to excellence, customer satisfaction, and driving 
                digital transformation across industries.
              </p>
              <p className="text-lg text-gray-600 leading-relaxed">
                We aim to bridge the technology gap by offering scalable and 
                future-proof solutions that help businesses thrive in a digital-first world.
              </p>
            </div>
            <div className="relative">
              <img
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-green-50 p-8 rounded-2xl">
              <h3 className="text-2xl font-bold text-gray-900 mb-6">Our Vision</h3>
              <p className="text-lg text-gray-600 mb-6">
                To be a leading IT services provider in Nigeria and beyond, recognized 
                for innovation, reliability, and delivering technology solutions that 
              ...
              <div className="flex items-center space-x-4 text-sm text-gray-500">
                ...
                <Calendar className="h-5 w-5" />
                <span>Focused on IT Excellence</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Our Core Values</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              These principles drive our approach to building world-class IT solutions and services.
            </p>
          </div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Our Journey</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Since our registration in 2025, we have rapidly grown as a trusted IT 
              service provider, delivering solutions that make a difference.
            </p>
          </div>
      ...
      <section className="bg-gradient-to-r from-green-600 to-blue-600 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Let Polynovex deliver the IT solutions your business needs to grow and scale. 
            Talk to us today about your digital transformation goals.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/contact"
