          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <a
                  href="https://wa.me/2348134393554?text=Hello%20Polynovex,%20I'm%20interested%20in%20Stalo%20Paint"
                  target="_blank"
      ...
      <section className="bg-gradient-to-r from-blue-800 to-green-600 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="https://wa.me/2348134393554?text=Hello%20Polynovex,%20I%20need%20a%20quote%20for%20Stalo%20Paint"
              target="_blank"
              rel="noopener noreferrer"
